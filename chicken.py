...
if not CHOSEN_FLOOR.isdigit() or not int(CHOSEN_FLOOR) in range(0, 10):
    # if player has entered an invalid floor (ie. not a number between 0 and 10
    print "Invalid floor...."
elif int(CHOSEN_FLOOR) == CURRENT_FLOOR:
